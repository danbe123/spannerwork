...
const ToastProvider = React.forwardRef<HTMLDivElement, ToastProviderProps>(({ ...props }, ref) => (
  <div
    ref={ref}
...
const ToastAction = React.forwardRef<HTMLDivElement, ToastActionProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
